...
func migrateDB() error {
	...
	err = dbConn.AutoMigrate(&models.User{}, &models.MuscleGroup{}, &models.StrengthExercise{}, &models.StrengthWorkout{}, &models.CoreExercise{}, &models.CoreWorkout{}, &models.YogaExercise{}, &models.YogaWorkout{})
	if err != nil {
		return err
	}
